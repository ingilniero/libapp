Feature: Create book
  ...
  Only authenticated readers can create new books.
  ...
  Scenario: Try to create a new book with empty title as logged in reader
    Given I am a "john@reader.com" reader
  ...
  Scenario: Try to create a new book as guest user
    Given I am a guest
